...
public class CourierController {
    ...
    @PostMapping("/change-status/{courierId}")
    public ResponseEntity<Void> changeStatus(@PathVariable UUID courierId, @RequestParam CourierStatus status) {
        service.changeStatus(courierId, status);
